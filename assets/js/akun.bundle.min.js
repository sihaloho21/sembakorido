...
`).map(p=>p.trim()).filter(p=>p!==""&&!/^isi paket\s*:\s*$/i.test(p)).map(p=>p.replace(/^[\-•]\s*/,"").trim()).filter(p=>p!==""),h=["\u{1F35C}","\u{1F372}","\u{1F4E6}","\u2615","\u{1F35A}","\u{1F373}","\u{1F9C2}"];s.innerHTML=g.map((p,c)=>`
    ...
    `,document.body.appendChild(t),setTimeout(()=>t.remove(),5e3)}function toggleLocationField(){const e=document.querySelector('input[name="ship-method"]:checked'),t=document.getElementById("location-field"),n=document.getElementById("delivery-location-ui"),a=document.getElementById("pickup-location-ui");e&&(e.value==="Antar Nikomas"?(t.classList.add("hidden"),n.classList.add("hidden"),a.classList.add("hidden")):e.value==="Antar Kerumah"?(t.classList.remove("hidden"),n.classList.remove("hidden"),a.classList.add("hidden")):e.value==="Ambil Ditempat"&&(t.classList.remove("hidden"),n.classList.add("hidden"),a.classList.remove("hidden"))),updateOrderTotal()}function getCurrentLocation(){const e=document.getElementById("get-location-btn"),t=document.getElementById("location-link");navigator.geolocation?(e.disabled=!0,e.innerHTML="<span>\u231B Mengambil Lokasi...</span>",navigator.geolocation.getCurrentPosition(n=>{const a=`https://www.google.com/maps?q=${n.coords.latitude},${n.coords.longitude}`;t.value=a,e.classList.remove("bg-white","text-blue-700","border-blue-200"),e.classList.add("bg-green-600","text-white","border-green-600"),e.innerHTML="<span>\u2705 Lokasi Berhasil Dibagikan</span>",alert("Lokasi berhasil diambil!")},n=>{e.disabled=!1,e.innerHTML="<span>\u{1F4CD} Bagikan Lokasi Saya</span>";let a="Gagal mengambil lokasi.";n.code===1&&(a="Mohon izinkan akses lokasi untuk fitur ini."),alert(a)},{enableHighAccuracy:!0,timeout:5e3,maximumAge:0})):alert("Geolocation tidak didukung oleh browser Anda")}function updateOrderTotal(){const e=document.querySelector('input[name="pay-method"]:checked'),t=document.querySelector('input[name="ship-method"]:checked'),n=e&&e.value==="Bayar Gajian",a=t&&t.value==="Antar Nikomas";let o=0;cart.forEach(h=>{const p=n?h.hargaGajian:h.harga,c=calculateTieredPrice(p,h.qty,h.grosir);o+=c*h.qty});const r=a?2e3:0,s=o+r,d=document.getElementById("sticky-order-total"),l=document.getElementById("order-summary-total");d&&(d.innerText=`Rp ${s.toLocaleString("id-ID")}`),l&&(l.innerText=`Rp ${s.toLocaleString("id-ID")}`);const i=document.getElementById("order-subtotal"),g=document.getElementById("order-shipping");i&&(i.innerText=`Rp ${o.toLocaleString("id-ID")}`),g&&(g.innerText=`Rp ${r.toLocaleString("id-ID")}`),updateOrderCTAState()}function isOrderFormValid(){const e=document.getElementById("customer-name"),t=document.getElementById("customer-phone"),n=document.querySelector('input[name="pay-method"]:checked'),a=document.querySelector('input[name="ship-method"]:checked');if(!e||!t)return!1;const o=e.value.trim(),r=o.replace(/\s/g,"");if(!o||r.length<4)return!1;const s=t.value.trim();return s?!(normalizePhone(s).replace(/[^0-9]/g,"").length<10)&&!!(n&&a):!1}function updateOrderCTAState(){const e=document.getElementById("send-order-btn")||document.querySelector('[data-action="send-wa"]');if(!e)return;const t=isOrderFormValid();e.disabled=!t,e.setAttribute("aria-disabled",String(!t))}function normalizePhone(e){if(!e)return"";let t=e.toString().replace(/[^0-9]/g,"");return t.startsWith("62")?t="0"+t.slice(2):t.startsWith("8")?t="0"+t:t.startsWith("0")||(t="0"+t),t.startsWith("0")&&!t.startsWith("08")&&t.length,t}function generateOrderId(){const e="0123456789";let t="";for(let n=0;n<6;n++)t+=e.charAt(Math.floor(10*Math.random()));return`ORD-${t}`}async function logOrderToGAS(e){const t={id:e.id||generateOrderId(),pelanggan:e.pelanggan||"",produk:e.produk||"",qty:e.qty||0,total:e.total||0,status:e.status||"Pending",tanggal:e.tanggal||new Date().toLocaleString("id-ID"),phone:e.phone||"",poin:e.poin||0,point_processed:e.point_processed||"No"};console.log("\u{1F4DD} Logging order to GAS:",t);try{const n=await GASActions.create("orders",t);return console.log("\u2705 Order logged successfully:",n),n}catch(n){throw console.error("\u274C Error logging order to GAS:",n),n}}async function sendToWA(){const e=event?.target||document.querySelector('[data-action="send-wa"]');if(e&&e.disabled)return;const t=document.getElementById("customer-name").value,n=document.getElementById("customer-phone").value,a=document.querySelector('input[name="pay-method"]:checked')?.value,o=document.querySelector('input[name="ship-method"]:checked')?.value;if(!t||t.trim().length===0)return void alert("Masukkan Nama Lengkap");const r=t.replace(/\s/g,"");if(r.length<4)return void alert("Masukkan Nama Lengkap");const s=r.toLowerCase(),d=[/^(.)\1{3,}$/,/^(.{2})\1{2,}$/,/^(.{3})\1{2,}$/,/^([a-z])([a-z])\1\2{2,}$/];for(const b of d)if(b.test(s))return void alert("Masukkan Nama Lengkap");if(!n||n.trim().length===0)return void alert("Nomor WhatsApp tidak valid");const l=n.replace(/[^0-9]/g,"");if(l.length<10)return void alert("Nomor WhatsApp tidak valid");const i=[/^(\d)\1{9,}$/,/^08(\d)\1{8,}$/,/^(\d{2})\1{4,}$/,/^(\d{3})\1{3,}$/];for(const b of i)if(b.test(l))return void alert("Nomor WhatsApp tidak valid");if(!a)return void alert("Pilih metode pembayaran terlebih dahulu");if(!o)return void alert("Pilih metode pengiriman terlebih dahulu");e&&(e.disabled=!0,e.innerHTML=`
        ...
        `,e.classList.add("opacity-75","cursor-not-allowed"));let g="";g=o==="Antar Nikomas"?"Antar Nikomas (Area PT Nikomas Gemilang)":o==="Antar Kerumah"?"Antar Kerumah (Area Serang & sekitarnya)":"Ambil Ditempat (Kp. Baru, Kec. Kibin)";const h=a==="Bayar Gajian";let p=0,c=0,u="",m="";cart.forEach((b,E)=>{const w=h?b.hargaGajian:b.harga,I=calculateTieredPrice(w,b.qty,b.grosir),B=I<w,S=I*b.qty;p+=S,c+=b.qty;const $=b.selectedVariation?` (${b.selectedVariation.nama})`:"",A=B?` (Harga Grosir: Rp ${I.toLocaleString("id-ID")}/unit)`:"";u+=`${E+1}. ${b.nama}${$} x${b.qty}${A} = Rp ${S.toLocaleString("id-ID")}
`,m+=`${b.nama}${$} (x${b.qty}) | `});const f=o==="Antar Nikomas"?2e3:0;p+=f;const y=CONFIG.getRewardConfig().pointValue||1e4,x=Math.floor(p/y),v=generateOrderId(),k=document.getElementById("location-link")?.value||"",C=`*PESANAN BARU - GOSEMBAKO*
